...
<!-- <title> 金融网新手引导,平台介绍-金融网-CFCA认证的互联网金融公司</title> -->
<title>金融网新手引导,平台介绍-金融网-CFCA认证的互联网金融公司</title>
...
<div id="fullpage" class="new-guidelines">
  ...
  <div id="page2" class="section flash-box" style=" background:#539ce7;">
      ...
      <img src="images/img-1.png" class="inner-img inner-img-1" alt="金融网介绍"/> 
      <img src="images/img-2.png" class="inner-img inner-img-2" alt="金融网简介"/> 
      ...
      <img src="images/img-8.png" class="inner-img inner-img-8" style = "right:199px; top:78px;" id = "img5" alt="金融网快速发展"/>
  ...
  <div id="page3" class="section flash-box" style=" background:#56DBBE;">
    ...
    <img src="images/img-17.png" class="inner-img inner-img-17 a-auto-1 inner-img-17-a" alt="金融模式"/> 
  ...
  <div id="page5" class="section flash-box" style=" background:#CFEBF9 url(images/img-31.png) no-repeat center top;">
    <div class="flash-inner inner4" style="height:400px; top:23%; padding:0px; margin-top:0px; display:none;"> 
	    <img src="images/img-32.png" width="192" height="209" class="inner-img inner-img-32" style="top:0%;" alt="选金融 多重好礼"/>
