    ...
    <div class="homeWap">
      <div class="footer-section clearfix">
        ...
        <div class="footer-contactus">
          ...
          <p>客服邮箱：<a style="cursor:pointer;" onclick="location.href='mailto:kefu@bjpowernode.com'">kefu@aaabbb.com</a></p>
        </div>
        <div class="footer-ewm">
         <%--  <img src="${pageContext.request.contextPath}/images/weixin01.png" alt="金融网订阅号" /> --%>
          <p>金融网订阅号</p>
        </div>
        <div class="footer-ewm">
         <%--  <img src="${pageContext.request.contextPath}/images/weixin02.png" alt="金融网服务号" /> --%>
          <p>金融网服务号</p>
        </div>
      </div>
      <div class="copyright">版权所有 ©2017 北京教育科技有限公司   京ICP备09088888号   |   <img src="${pageContext.request.contextPath}/images/jinghui.png" alt="京公网安备" />京公网安备11030808027468</div>
