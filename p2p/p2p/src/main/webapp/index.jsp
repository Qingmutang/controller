...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
   	...
   	<meta name="description" content="金融网是集团旗下一站式互联网金融平台.接入支付清算协会风险系统，用互联网技术和金融创新使投资与借贷更透明、更高效.优选互联网金融产品随心选。"/>
    <title>金融网官网-专业的互联网金融信息服务平台</title>
...
<div class="flashImg">
    ...
    <div class="registerBody">
        ...
        <div class="register welcome">
            <div class="welcome-txt">欢迎 <span>“<b>${user.phone}</b>”</span><br/>来金融网投资！</div>
