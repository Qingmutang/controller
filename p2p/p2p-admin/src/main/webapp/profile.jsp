										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="${pageContext.request.contextPath}/assets/images/avatars/profile-pic.jpg" />
												</span>
												...
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
															...
															&nbsp;
															<span class="white">${userInfoDetail.username}</span>
														</a>
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username">${userInfoDetail.username}</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="country">${userInfoDetail.orgInfo.orgName}</span>
														<span class="editable" id="city">${userInfoDetail.orgInfo.pOrgName}</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="signup"><fmt:formatDate value="${userInfoDetail.staffInfo.hiredate}" pattern="yyyy年MM月dd日"/></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="login"><fmt:formatDate value="${userInfoDetail.lastlogintime}" pattern="yyyy年MM月dd日 HH:mm:ss"/></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about">${userInfoDetail.staffInfo.jobtitle}</span>
													</div>
												</div>
											</div>
