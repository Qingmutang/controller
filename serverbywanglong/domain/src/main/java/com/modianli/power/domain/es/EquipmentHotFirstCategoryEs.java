...
@Data
@Builder
@Document(indexName = "equipment_v1", type = "hot_category", shards = 1, replicas = 0, refreshInterval = "-1")
public class EquipmentHotFirstCategoryEs implements Serializable {
  ...
  @Field(index = FieldIndex.not_analyzed,type = FieldType.Nested)
  private List<EquipmentThirdCategoryEs> hotThirdCategoryEs;
