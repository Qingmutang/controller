...
public interface LockService {
   ...
   * @param value the value of the lock (which has to match the value when it was acquired)
   ...
   * @throws LockNotHeldException if the value does not match the current value or if the lock doesn't exist (e.g. if it expired)
   */
